...
public class RegionBBSManager extends BaseBBSManager
{
	 ...
	 * 
	 * @see
	 * net.l2emuproject.gameserver.communitybbs.Manager.BaseBBSManager#parsecmd(java
	 * .lang.String, net.l2emuproject.gameserver.world.object.instance.L2PcInstance)
	 */
	@Override
		...
		private String generateHtml(int page)
		{
			...
			htmlCode.append("<table width=600>");
			{
				htmlCode.append(trOpen);
				{
					...
					htmlCode.append(colSpacer);
					htmlCode.append(tdOpen).append("Server Restarted: ").append(L2GameServer.getStartedTime().getTime()).append(tdClose);
				}
