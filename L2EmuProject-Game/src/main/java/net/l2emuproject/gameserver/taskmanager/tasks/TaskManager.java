...
import static net.l2emuproject.gameserver.taskmanager.tasks.TaskTypes.TYPE_SHEDULED;
import static net.l2emuproject.gameserver.taskmanager.tasks.TaskTypes.TYPE_TIME;
