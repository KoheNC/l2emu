...
public class IncrementIDFactory extends IdFactory
{
	...
	/* (non-Javadoc)
	 * @see net.l2emuproject.gameserver.idfactory.IdFactory#getNextId()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.l2emuproject.gameserver.idfactory.IdFactory#releaseId(int)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.l2emuproject.gameserver.idfactory.IdFactory#size()
	 */
	@Override
	public int size()
	{
