...
import net.l2emuproject.gameserver.world.object.instance.L2SiegeTeleporterInstance;
...
public class MercTicketManager
{
	...
	{
		_typeLimit = new FastMap<Integer, Integer>().shared();
		fillTypes();
		_mercenaries = new FastMap<Integer, MercInfo>().shared();
		fillMercenaries();
