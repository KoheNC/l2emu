...
import net.l2emuproject.gameserver.dataholders.MerchantPriceConfigDataHolder.MerchantPriceConfig;
...
public class L2MerchantInstance extends L2NpcInstance implements L2Merchant
{
	...
	{
		super.onSpawn();
		_mpc = MerchantPriceConfigDataHolder.getInstance().getMerchantPriceConfig(this);
	}
