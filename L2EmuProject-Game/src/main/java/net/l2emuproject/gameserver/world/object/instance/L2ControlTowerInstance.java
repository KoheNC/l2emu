...
public class L2ControlTowerInstance extends L2Npc
{
    ...
    public boolean isAutoAttackable(L2Character attacker)
	{
		...
		return (attacker != null
		        && attacker instanceof L2Player
		        && getCastle() != null
		        && getCastle().getCastleId() > 0
		        && getCastle().getSiege().getIsInProgress()
		        && getCastle().getSiege().checkIsAttacker(((L2Player)attacker).getClan()));
	}
     ...
     *
     * @see net.l2emuproject.gameserver.world.object.instance.L2NpcInstance#decayMe()
     */
    @Override
