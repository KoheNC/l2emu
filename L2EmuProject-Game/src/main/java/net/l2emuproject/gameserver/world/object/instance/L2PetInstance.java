...
import net.l2emuproject.gameserver.entity.stat.PetStat;
import net.l2emuproject.gameserver.entity.status.CharStatus;
import net.l2emuproject.gameserver.entity.status.PetStatus;
...
public class L2PetInstance extends L2Summon
{
	...
	public synchronized static L2PetInstance spawnPet(L2NpcTemplate template, L2Player owner, L2ItemInstance control)
	{
