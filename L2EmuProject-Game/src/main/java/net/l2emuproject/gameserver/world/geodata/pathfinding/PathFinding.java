 ...
 */
package net.l2emuproject.gameserver.world.geodata.pathfinding;
...
import net.l2emuproject.gameserver.world.geodata.pathfinding.geonodes.GeoPathFinding;
import net.l2emuproject.gameserver.world.geodata.pathfinding.utils.BinaryNodeHeap;
import net.l2emuproject.gameserver.world.geodata.pathfinding.utils.CellNodeMap;
...
public abstract class PathFinding
{
	...
	public final Node[] searchByClosest(Node start, Node end, int instanceId)
	{
		...
		try
		{
			...
			boolean added;
			int i = 0;
			while (i < Config.GEODATA_MAX_PATHFINDING_LENGTH)
			{
				if (to_visit.isEmpty())
				{
					// No Path found
