...
public abstract class ConditionParser
{
	...
	private Condition parsePlayerCondition(String nodeName, String nodeValue)
	{
		...
		else if ("pkCount".equalsIgnoreCase(nodeName))
		{
			int expIndex = Integer.decode(nodeValue);
			return new ConditionPlayerPkCount(expIndex);
		}
		...
		else if ("siegeside".equalsIgnoreCase(nodeName))
		{
			int value = Integer.decode(nodeValue);
			return new ConditionPlayerSiegeSide(value);
		}
		...
		else if ("souls".equalsIgnoreCase(nodeName))
		{
			int value = Integer.decode(nodeValue);
			return new ConditionPlayerSouls(value);
		}
		...
		{
			int cloakStatus = Integer.decode(nodeValue);
			return new ConditionPlayerCloakStatus(cloakStatus);
		}
