...
*/
    ...
    public static final boolean addSummon(L2Character caster, L2Player owner, int radius, boolean isDead)
    {
	...
	private boolean canCreateEffect(L2Character activeChar, L2Character target, L2Skill skill)
	{
		if (skill.isPassive())
			return false;
