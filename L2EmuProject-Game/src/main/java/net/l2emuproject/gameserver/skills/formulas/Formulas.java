...
public final class Formulas
{
	...
	private enum TypeDam
	{
		PHYS, MAGIC, BLOW;
	}
	
	private static final double balanceDamage(L2Character attacker, L2Character target, double damage, TypeDam type)
	{
	...
	private static double calcDamage(L2Character activeChar, L2Character target, double damage, L2Skill skill, TypeDam type)
	{
		return balanceDamage(activeChar, target, calcDamage(activeChar, target, damage, skill), type);
	}
	
	private static double calcDamage(L2Character activeChar, L2Character target, double damage, L2Skill skill)
	{	
		if (target instanceof L2Attackable)
		{
