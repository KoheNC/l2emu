...
public class ExPutEnchantSupportItemResult extends L2GameServerPacket
{
	...
	/**
	 * @see net.l2emuproject.gameserver.network.serverpackets.L2GameServerPacket#getType()
	 */
	@Override
	...
	/**
	 * @see net.l2emuproject.gameserver.network.serverpackets.L2GameServerPacket#writeImpl()
	 */
	@Override
