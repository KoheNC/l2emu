...
import net.l2emuproject.gameserver.network.serverpackets.CharacterDeleteFail;
import net.l2emuproject.gameserver.network.serverpackets.CharacterDeleteSuccess;
