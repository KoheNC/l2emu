...
public class PetDataTable
{
	...
	// vitamin pets
	public final static int											WHITE_WIESEL_ID				= 16045;
	public final static int											FIERY_PRINCESS_ID			= 16046;
	public final static int											WILD_BEAST_ID				= 16044;
	public final static int											FOX_SHAMAN_ID				= 16043;
	
	public final static int											TOY_KNIGHT_ID				= 16052;
	public final static int											SOUL_MONK_ID				= 16051;
	...
	private static enum L2Pet
	{
		...
		WHITE_WIESEL(WHITE_WIESEL_ID, 13017, EMPTY_INT, false),
		FIERY_PRINCESS(FIERY_PRINCESS_ID, 13018, EMPTY_INT, false),
		WILD_BEAST(WILD_BEAST_ID, 13019, EMPTY_INT, false),
		FOX_SHAMAN(FOX_SHAMAN_ID, 13020, EMPTY_INT, false),
		
		TOY_KNIGHT(TOY_KNIGHT_ID, 13548, EMPTY_INT, false),
		SOUL_MONK(SOUL_MONK_ID, 13549, EMPTY_INT, false),
		OWL_MONK(OWL_MONK_ID, 13550, EMPTY_INT, false),
		TOURTLE_ASCETIC(TOURTLE_ASCETIC_ID, 13551, EMPTY_INT, false);
		// L2EMU_ADD
