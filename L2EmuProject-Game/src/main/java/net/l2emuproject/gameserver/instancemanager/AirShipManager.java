...
{
	private static final Log						_log				= LogFactory.getLog(AirShipManager.class);
	...
	private final Map<Integer, StatsSet>			_airShipsInfo		= new FastMap<Integer, StatsSet>();
	private final Map<Integer, L2AirShipInstance>	_airShips			= new FastMap<Integer, L2AirShipInstance>();
	private final Map<Integer, AirShipTeleportList>	_teleports			= new FastMap<Integer, AirShipTeleportList>();
	...
	public L2AirShipInstance getNewAirShip(int x, int y, int z, int heading)
	{
		...
		airShip.getPosition().setXYZInvisible(x, y, z);
		airShip.spawnMe();
