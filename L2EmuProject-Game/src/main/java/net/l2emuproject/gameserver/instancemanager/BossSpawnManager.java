...
public abstract class BossSpawnManager
{
	...
	{
		_bosses = new FastMap<Integer, L2Boss>().shared();
		_schedules = new FastMap<Integer, ScheduledFuture<?>>().shared();
		_storedInfo = new FastMap<Integer, StatsSet>().shared();
		_spawns = new FastMap<Integer, L2Spawn>().shared();
		init();
	}
