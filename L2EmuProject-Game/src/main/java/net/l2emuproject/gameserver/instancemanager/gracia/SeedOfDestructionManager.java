 ...
 */
package net.l2emuproject.gameserver.instancemanager.gracia;
...
public final class SeedOfDestructionManager
{
	...
	private static final int[]		DOORLIST				=
															{
			12240001,
			12240002,
			12240003,
	...
	private static final int[]		ENERGY_SEEDS			=
	...
	public static final byte		STATE_DEFENSE			= 2;

	public static final byte		STATE_HUNTING_GROUND	= 3;
	...
	{
		_state = props.getByte("sod_state", STATE_ATTACK);
	...
	private final void startDefenseMode()
	{
	...
	public final long getTiatKilled()
	{
		return _tiatKills;
	}
	...
	public final void increaseTiatKills()
	{
		setTiatKilled(_tiatKills + 1);
	}

	public final void setTiatKilled(long kills)
	{
		_tiatKills = kills;
	...
	public final void setHuntingGroundTimer(long time)
	{
		_defenseSwitch = time;
	}

	public final long getHuntingGroundTimer()
	{
		return _defenseSwitch;
	}

	public final void runDefenseMode()
	{
		new SwitchToDefenseMode().run();
	}

	public final void startHuntingGround()
	{
		_log.info("Seed of Destruction: Hunting ground started.");
		setState(STATE_HUNTING_GROUND);
