 ...
 */
package net.l2emuproject.gameserver.templates.item;
...
public abstract class L2Item implements FuncOwner
{
	...
	protected L2Item(AbstractL2ItemType type, StatsSet set)
	{
		...
		_pvpItem = (_itemId >= 10667 && _itemId <= 10792) || (_itemId >= 10793 && _itemId <= 10835) || (_itemId >= 12852 && _itemId <= 12977)
		|| (_itemId >= 14363 && _itemId <= 14519) || (_itemId >= 14520 && _itemId <= 14525) || _itemId == 14528 || _itemId == 14529 || _itemId == 14558
		|| (_itemId >= 15913 && _itemId <= 16024) || (_itemId >= 16134 && _itemId <= 16147) || _itemId == 16149 || _itemId == 16151 || _itemId == 16153
		|| _itemId == 16155 || _itemId == 16157 || _itemId == 16159 || (_itemId >= 16168 && _itemId <= 16176) || (_itemId >= 16179 && _itemId <= 16220);
	}
	...
	{
		if (activeChar instanceof L2Player && activeChar.getActingPlayer().isGM() &&
