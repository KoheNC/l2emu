	...
	public boolean useAdminCommand(String command, L2Player activeChar)
	{
		...
		if (command.startsWith("admin_cw_info"))
		{
			...
			else
			{
				...
				adminReply.setFile("data/npc_data/html/admin/cwinfo.htm");
				for (CursedWeapon cw : cwm.getCursedWeapons())
				{
					itemId = cw.getItemId();
					...
					if (cw.isActivated())
					{
						...
						replyMSG.append("<tr><td><button value=\"Remove\" action=\"bypass -h admin_cw_remove " + String.valueOf(itemId)
								+ "\" width=73 height=15 back=\"L2UI_ct1.button_df\" fore=\"L2UI_ct1.button_df\"></td>");
						replyMSG.append("<td><button value=\"Go\" action=\"bypass -h admin_cw_goto " + String.valueOf(itemId)
