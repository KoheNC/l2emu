 ...
 * @author lord_rex
 */
public final class GrandBossStat extends BossStat
{
	public GrandBossStat(L2GrandBossInstance boss)
	{
		super(boss);
	}
	...
	public final int getPAtk(final L2Character target)
	{
		...
		return (int) (val * Config.GB_PDAMAGE_MULTIPLIER);
	}
	...
	public final int getMAtk(final L2Character target, final L2Skill skill)
	{
		...
		return (int) (val * Config.GB_MDAMAGE_MULTIPLIER);
	}
	...
	public final int getPDef(final L2Character target)
	{
		...
		return (int) (val * Config.GB_PDEFENCE_MULTIPLIER);
	}
	...
	public final int getMDef(final L2Character target, final L2Skill skill)
	{
		...
		return (int) (val * Config.GB_MDEFENCE_MULTIPLIER);
	}

	@Override
	public final L2GrandBossInstance getActiveChar()
	{
