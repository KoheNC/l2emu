...
import net.l2emuproject.gameserver.script.Parser;
import net.l2emuproject.gameserver.script.ParserNotCreatedException;
import net.l2emuproject.gameserver.script.ScriptDocument;
import net.l2emuproject.gameserver.script.ScriptEngine;
...
{
	private static Log					_log				= LogFactory.getLog(L2GameServer.class);
