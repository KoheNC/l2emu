...
import net.l2emuproject.gameserver.model.zone.form.Shape;
...
public class L2Zone implements FuncOwner
{
	...
	private final FastMap<L2Character, Boolean> _charactersInside = new FastMap<L2Character, Boolean>().shared();
	...
	public static L2Zone parseZone(Node zn)
	{
		...
		try
		{
			...
			Class<?> clazz = Class.forName("net.l2emuproject.gameserver.model.zone." + type.getZoneClassName());
