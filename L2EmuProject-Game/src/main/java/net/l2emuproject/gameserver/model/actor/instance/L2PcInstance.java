...
import net.l2emuproject.gameserver.ai.L2PlayerAI;
...
import net.l2emuproject.gameserver.model.actor.effects.PcEffects;
import net.l2emuproject.gameserver.model.actor.knownlist.CharKnownList;
import net.l2emuproject.gameserver.model.actor.knownlist.PcKnownList;
import net.l2emuproject.gameserver.model.actor.reference.ClearableReference;
...
import net.l2emuproject.gameserver.model.actor.shot.PcShots;
import net.l2emuproject.gameserver.model.actor.skills.PcSkills;
...
import net.l2emuproject.gameserver.model.base.ClassLevel;
...
import net.l2emuproject.gameserver.model.entity.player.PlayerBirthday;
import net.l2emuproject.gameserver.model.entity.player.PlayerCertification;
import net.l2emuproject.gameserver.model.entity.player.PlayerCustom;
import net.l2emuproject.gameserver.model.entity.player.PlayerDuel;
import net.l2emuproject.gameserver.model.entity.player.PlayerEventData;
import net.l2emuproject.gameserver.model.entity.player.PlayerFish;
import net.l2emuproject.gameserver.model.entity.player.PlayerHenna;
import net.l2emuproject.gameserver.model.entity.player.PlayerObserver;
import net.l2emuproject.gameserver.model.entity.player.PlayerOlympiad;
import net.l2emuproject.gameserver.model.entity.player.PlayerRecipe;
import net.l2emuproject.gameserver.model.entity.player.PlayerSettings;
...
import net.l2emuproject.gameserver.model.itemcontainer.PcRefund;
...
public final class L2PcInstance extends L2Playable implements ICharacterInfo
{
	...
	public class AIAccessor extends L2Character.AIAccessor
	{
		...
		public void doAttack(L2Character target)
		{
			...
			if (target.getActingPlayer() != null 
					...
					&& target.getActingPlayer() != L2PcInstance.this 
	...
	public boolean isAutoAttackable(L2Character attacker)
	{
		...
		if (attacker instanceof L2PcInstance && ((L2PcInstance) attacker).getPlayerOlympiad().isInOlympiadMode())
		{
			return getPlayerOlympiad().isInOlympiadMode() && getPlayerOlympiad().isOlympiadStart() && ((L2PcInstance) attacker).getPlayerOlympiad().getOlympiadGameId() == getPlayerOlympiad().getOlympiadGameId();
		}
	...
	public boolean checkPvpSkill(L2Object obj, L2Skill skill, boolean srcIsSummon)
	{
		...
		if (obj != this && // Target is not self and
				...
				!(getPlayerDuel().isInDuel() && ((L2PcInstance) obj).getPlayerDuel().getDuelId() == getPlayerDuel().getDuelId()) && // Self is not in a duel and attacking opponent
	...
	class WaterTask implements Runnable
	{
		...
		public void run()
		{
			...
			if(getStatus().reduceHp(reduceHp, L2PcInstance.this, false, false, false))
			{
	...
	public void onPlayerEnter()
	{
		...
		if (!isGM())
		{
			...
			else if (AntharasManager.getInstance().checkIfInZone(this))
			{
				...
				if (System.currentTimeMillis() - L2GameServer.getStartedTime().getTimeInMillis() <= Config.ALT_TIMELIMITOFINVADE)
				{
			...
			else if (BelethManager.getInstance().checkIfInZone(this))
			{
				if (getQuestState("Beleth") != null)
					getQuestState("Beleth").exitQuest(true);	
				teleToLocation(TeleportWhereType.Town);
			}
			// Sailren
			else if (SailrenManager.getInstance().checkIfInZone(this))
