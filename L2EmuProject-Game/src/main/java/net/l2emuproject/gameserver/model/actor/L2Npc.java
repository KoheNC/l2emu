...
import net.l2emuproject.gameserver.model.actor.instance.L2DoormenInstance;
...
import net.l2emuproject.gameserver.model.actor.instance.L2TeleporterInstance;
import net.l2emuproject.gameserver.model.actor.instance.L2TrainerInstance;
...
import net.l2emuproject.gameserver.model.actor.shot.NpcShots;
import net.l2emuproject.gameserver.model.actor.stat.CharStat;
import net.l2emuproject.gameserver.model.actor.stat.NpcStat;
import net.l2emuproject.gameserver.model.actor.status.CharStatus;
import net.l2emuproject.gameserver.model.actor.status.NpcStatus;
import net.l2emuproject.gameserver.model.actor.view.CharLikeView;
import net.l2emuproject.gameserver.model.actor.view.NpcView;
...
public class L2Npc extends L2Character
{
	 ...
	 *
	 */
	public void makeSupportMagic(L2PcInstance player, String cmd, boolean servitor)
	{
