...
import static net.l2emuproject.gameserver.system.taskmanager.tasks.TaskTypes.TYPE_SHEDULED;
import static net.l2emuproject.gameserver.system.taskmanager.tasks.TaskTypes.TYPE_TIME;
