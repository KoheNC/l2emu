...
import net.l2emuproject.util.concurrent.RunnableStatsManager.SortBy;
import net.l2emuproject.util.concurrent.ScheduledFutureWrapper;
...
public final class ThreadPoolManager
{
	...
	private ThreadPoolManager()
	{
		...
		_log.info(getClass().getSimpleName() + " : Initialized with " + _scheduledPool.getPoolSize() + " scheduler, "
	...
	public void shutdown()
	{
		...
		if (TimeUnit.HOURS.toMillis(12) < (System.currentTimeMillis() - L2GameServer.getStartedTime().getTimeInMillis()))
