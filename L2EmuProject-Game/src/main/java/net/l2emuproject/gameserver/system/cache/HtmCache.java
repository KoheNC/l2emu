 ...
 */
package net.l2emuproject.gameserver.system.cache;
...
import net.l2emuproject.gameserver.network.serverpackets.AbstractNpcHtmlMessage;
...
public final class HtmCache
{
	...
	private void validate()
	{
		...
		{
			// L2EMU_EDIT
			_log.warn("Invalid tags used: " + set.size());
			for (String tag : set)
				_log.warn(tag);
			// L2EMU_EDIT
		}
	...
	public String loadFile(File file)
	{
		if (isLoadable(file))
		{
			...
			try
			{
				...
				String content = new String(raw, Config.HTML_ENCODING);
