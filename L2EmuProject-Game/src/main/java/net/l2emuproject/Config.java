...
public class Config extends L2Config
{
	 ...
	 * Beleth CONFIG *
	 *******************************************/
	public static int			BELETH_DOOR_WAIT_TIME;
	public static int			BELETH_SPAWN_WAIT_TIME;
	public static int			BELETH_ACTIVITY_TIME;
	public static long			BELETH_RESPAWN_TIME;
	...
	private static final class BossConfig extends ConfigPropertiesLoader
	{
		...
		{
			BELETH_DOOR_WAIT_TIME = Integer.parseInt(bossSettings.getProperty("BelethDoorWaitTime", "5"));

			if (BELETH_DOOR_WAIT_TIME < 1 || BELETH_DOOR_WAIT_TIME > 5)
				BELETH_DOOR_WAIT_TIME = 5;
			BELETH_DOOR_WAIT_TIME *= 60000;

			BELETH_SPAWN_WAIT_TIME = Integer.parseInt(bossSettings.getProperty("BelethSpawnWaitTime", "5"));

			if (BELETH_SPAWN_WAIT_TIME < 1 || BELETH_SPAWN_WAIT_TIME > 5)
				BELETH_SPAWN_WAIT_TIME = 5;
			BELETH_SPAWN_WAIT_TIME *= 60000;

			BELETH_ACTIVITY_TIME = Integer.parseInt(bossSettings.getProperty("BelethActivityTime", "120"));

			if (BELETH_ACTIVITY_TIME < 1 || BELETH_ACTIVITY_TIME > 120)
				BELETH_ACTIVITY_TIME = 120;
			BELETH_ACTIVITY_TIME *= 60000;

			BELETH_RESPAWN_TIME = Long.parseLong(bossSettings.getProperty("BelethRespawnTime", "72800000"));
