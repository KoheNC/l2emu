...
import net.l2emuproject.status.commands.ClassStats;
import net.l2emuproject.status.commands.GC;
import net.l2emuproject.status.commands.MemoryStatistics;
import net.l2emuproject.status.commands.Threads;
...
public abstract class StatusThread extends Thread
{
	...
	public final void run()
	{
		try
		{
			println("Welcome to the l2emuproject telnet server...");
			...
			println("[l2emuproject telnet console]");
