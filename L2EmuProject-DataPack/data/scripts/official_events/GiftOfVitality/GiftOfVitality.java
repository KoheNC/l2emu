 ...
 */
package official_events.GiftOfVitality;
 ...
 */
public class GiftOfVitality extends QuestJython
{
	private static final String		QN		= "GiftOfVitality";
	...
	{
		if (Config.ALLOW_GIFT_OF_VITALITY)
		{
			new GiftOfVitality(-1, QN, "official_events");
			_log.info("Official Events: Gift of Vitality is loaded.");
		}
		else
			_log.info("Official Events: Gift of Vitality is disabled.");
	}
}
