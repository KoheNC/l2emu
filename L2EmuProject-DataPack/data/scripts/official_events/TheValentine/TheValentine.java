 ...
 */
package official_events.TheValentine;
 ...
 * @author Gnacik
 */
public class TheValentine extends QuestJython
{
	private static final String		QN					= "TheValentine";
	...
	private static final DateRange	EVENT_DATES			= DateRange.parse(Config.THE_VALENTINE_DATE, new SimpleDateFormat("dd MM yyyy", Locale.US));
	...
	{
		if (Config.ALLOW_THE_VALENTINE)
		{
			new TheValentine(-1, QN, "official_events");
			_log.info("Official Events: The Valentine is loaded.");
		}
		else
			_log.info("Official Events: The Valentine is disabled.");
	}
}
