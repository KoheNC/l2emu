 ...
 *
 */
public class EvaGiftBox extends QuestJython
{
	private static final String QN = "EvaGiftBox";
	...
	public String onKill(L2Npc npc, L2Player killer, boolean isPet)
	{
		...
		{
			if (Rnd.nextBoolean())
				npc.dropItem(RED_CORAL, 1);
			else
				npc.dropItem(CRYSTAL_FRAGMENT, 1);
		}
		return null;
	}
