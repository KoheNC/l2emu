...
public final class DestroyPlaguebringers extends QuestJython
{
	...
	private DestroyPlaguebringers(int questId, String name, String descr)
	{
		...
		{ WERERAT_FANG, VAROOL_FOULCLAWS_FANG };
	...
	@Override
	public final String onEvent(String event, QuestState qs)
	{
	...
	{
		if (player == null)
			return null; // Is this really needed here?
	...
	{
		new DestroyPlaguebringers(316, QN, "Destroy Plague Bringers");
	}
}
