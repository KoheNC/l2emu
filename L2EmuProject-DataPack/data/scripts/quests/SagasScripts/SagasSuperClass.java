...
public class SagasSuperClass extends QuestJython
{
	...
	public int[]					Z				= {};
	public String[]					Text			= {};
	final FastMap<L2Npc, Integer>	_SpawnList		= new FastMap<L2Npc, Integer>().shared();
	...
	public String onAdvEvent(String event, L2Npc npc, L2Player player)
	{
		...
		if (st != null)
		{
			if (event.equalsIgnoreCase("0-011.htm") || event.equalsIgnoreCase("0-012.htm") || event.equalsIgnoreCase("0-013.htm")
					|| event.equalsIgnoreCase("0-014.htm") || event.equalsIgnoreCase("0-015.htm"))
				htmltext = event;
			...
			if (npcId == finalElement)
			{
				...
				if (st1 != null)
				{
					if (st1.getInt(CONDITION) == 15)
					{
						...
						st1.set(CONDITION, 16);
						st1.sendPacket(SND_MIDDLE);
					}
