...
public final class PathToOracle extends QuestJython
{
	...
	private PathToOracle(int questId, String name, String descr)
	{
		...
		{ CRYSTAL_MEDALLION, SWINDLERS_MONEY, ALLANAS_DIARY, LIZARD_CAPTAIN_ORDER, LEAF_OF_ORACLE, HALF_OF_DIARY, TAMILS_NECKLACE };
		addStartNpc(MANUEL);
		addTalkId(MANUEL);
		addTalkId(ALLANA);
		addTalkId(PERRIN);
	...
	{
		new PathToOracle(409, QN, "Path to Oracle");
	}
}
