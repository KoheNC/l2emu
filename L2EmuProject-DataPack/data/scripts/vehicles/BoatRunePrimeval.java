...
{
	private static final Log				_log				= LogFactory.getLog(BoatRunePrimeval.class);
	...
	public BoatRunePrimeval(L2BoatInstance boat)
	{
		...
		ARRIVED_AT_RUNE_2 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1991);
		LEAVING_RUNE = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1992);
		ARRIVED_AT_PRIMEVAL = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1988);
		ARRIVED_AT_PRIMEVAL_2 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1989);
		LEAVING_PRIMEVAL = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1990);
		BUSY_RUNE = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1993);
