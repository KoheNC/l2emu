...
{
	private static final Log				_log	= LogFactory.getLog(BoatInnadrilTour.class);
	...
	public BoatInnadrilTour(L2BoatInstance boat)
	{
		...
		ARRIVED_AT_INNADRIL = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 998);
		LEAVE_INNADRIL5 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 999);
		LEAVE_INNADRIL1 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1000);
		LEAVE_INNADRIL0 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1001);
		LEAVING_INNADRIL = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1002);

		ARRIVAL20 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1171);
		ARRIVAL15 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1172);
		ARRIVAL10 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1173);
		ARRIVAL5 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1174);
		ARRIVAL1 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1175);
