...
{
	private static final Log				_log			= LogFactory.getLog(BoatGludinRune.class);
	...
	public BoatGludinRune(L2BoatInstance boat)
	{
		...
		ARRIVED_AT_GLUDIN = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 986);
		ARRIVED_AT_GLUDIN_2 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1625);
		LEAVE_GLUDIN5 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1626);
		LEAVE_GLUDIN1 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1627);
		LEAVE_GLUDIN0 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1628);
		LEAVING_GLUDIN = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1629);
		ARRIVED_AT_RUNE = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1620);
		ARRIVED_AT_RUNE_2 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 980);
		LEAVE_RUNE5 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1621);
		LEAVE_RUNE1 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1622);
		LEAVE_RUNE0 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1623);
		LEAVING_RUNE = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1624);
		BUSY_GLUDIN = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1618);
		BUSY_RUNE = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1619);

		ARRIVAL_RUNE15 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1634);
		ARRIVAL_RUNE10 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1635);
		ARRIVAL_RUNE5 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1636);
		ARRIVAL_RUNE1 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1637);
		ARRIVAL_GLUDIN15 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1630);
		ARRIVAL_GLUDIN10 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1631);
		ARRIVAL_GLUDIN5 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1632);
		ARRIVAL_GLUDIN1 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1633);
