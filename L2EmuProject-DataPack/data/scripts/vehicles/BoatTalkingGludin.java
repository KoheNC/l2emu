...
{
	private static final Log				_log				= LogFactory.getLog(BoatTalkingGludin.class);
	...
	public BoatTalkingGludin(L2BoatInstance boat)
	{
		...
		ARRIVED_AT_TALKING_2 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 980);
		LEAVE_TALKING5 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 981);
		LEAVE_TALKING1 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 982);
		LEAVE_TALKING1_2 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 983);
		LEAVE_TALKING0 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 984);
		LEAVING_TALKING = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 985);
		ARRIVED_AT_GLUDIN = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 986);
		ARRIVED_AT_GLUDIN_2 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 987);
		LEAVE_GLUDIN5 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 988);
		LEAVE_GLUDIN1 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 989);
		LEAVE_GLUDIN0 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 990);
		LEAVING_GLUDIN = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 991);
		BUSY_TALKING = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1486);
		BUSY_GLUDIN = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1485);

		ARRIVAL_GLUDIN10 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1159);
		ARRIVAL_GLUDIN5 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1160);
		ARRIVAL_GLUDIN1 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1161);
		ARRIVAL_TALKING10 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1191);
		ARRIVAL_TALKING5 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1192);
		ARRIVAL_TALKING1 = new CreatureSay(0, SystemChatChannelId.Chat_Boat, 801, 1193);
