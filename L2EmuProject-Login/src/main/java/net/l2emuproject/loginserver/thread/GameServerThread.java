...
import net.l2emuproject.loginserver.gameserverpackets.BlowFishKey;
import net.l2emuproject.loginserver.gameserverpackets.ChangeAccessLevel;
import net.l2emuproject.loginserver.gameserverpackets.GameServerAuth;
import net.l2emuproject.loginserver.gameserverpackets.PlayerAuthRequest;
import net.l2emuproject.loginserver.gameserverpackets.PlayerInGame;
import net.l2emuproject.loginserver.gameserverpackets.PlayerLogout;
import net.l2emuproject.loginserver.gameserverpackets.PlayerTracert;
import net.l2emuproject.loginserver.gameserverpackets.ServerStatus;
import net.l2emuproject.loginserver.loginserverpackets.AuthResponse;
import net.l2emuproject.loginserver.loginserverpackets.InitLS;
import net.l2emuproject.loginserver.loginserverpackets.KickPlayer;
import net.l2emuproject.loginserver.loginserverpackets.LoginServerFail;
import net.l2emuproject.loginserver.loginserverpackets.PlayerAuthResponse;
import net.l2emuproject.loginserver.loginserverpackets.PlayerLoginAttempt;
...
public class GameServerThread extends NetworkThread
{
	...
	private void onReceivePlayerTracert(byte[] data)
	{
		if (isAuthed())
		{
			...
			try
			{
				LoginManager.getInstance().setAccountLastTracert(plt.getAccount(),
